...
#datavis.animate(training_step, 1000, train_data_update_freq=20, test_data_update_freq=100)
...
print("All variables: " + str(tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES)))

print("***************************")

print ("Trainale Variabes: " + str(tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES)))

#print("***************************")

#print ("Model Variabes: " + str(tf.get_collection(tf.GraphKeys.MODEL_VARIABLES)))
#saving the model
